      ...
      <div class="col-sm-9">
        <div class="row">
          <div class="col-sm-12">
            <h2>Inventario</h2>
            <br><br>
            <a button type="button" class="btn btn-success" href="GuardarInventario.php">
            ...
            <table id="lista_inventario" class="table table-sm table-bordered">
            </table>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
    ...
    $('#busqueda').keypress(function(){
      getListaInventarioBusqueda();
    })
	})
</script>
<script type="text/javascript">
	function getListaInventarioFecha(){
		$.ajax({
			type:"POST",
			url:"./ajax/lista_inventario.php",
			data: {
        "fecha_inicio":$('#fecha_inicio').val(),
        "fecha_fin":$('#fecha_fin').val()
      },
			success:function(r){
				$('#lista_inventario').html(r);
			}
		})
	}
  function getListaInventarioBusqueda(){
		$.ajax({
			type:"POST",
			url:"./ajax/lista_inventario.php",
			data: {
