<?php
	echo '<div class="dropdown-menu2" role="menu" style="display: block; position: static; margin-bottom: 10px;width: 240px;margin-left: 5px;margin-top: 10px;" aria-labelledby="dropdownmenu">
