      ...
      <div class="col-sm-9">
        <div class="row">
          <div class="col-sm-12">
            ...
            <table id="lista_docentes" class="table table-sm table-bordered">
            </table>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
	function getListaDocentesFecha(){
        ...
        "fecha_fin":$('#fecha_fin').val()
			...
			success:function(r){
				$('#lista_docentes').html(r);
			}
		})
	}
  function getListaDocentesBusqueda(){
		$.ajax({
			type:"POST",
